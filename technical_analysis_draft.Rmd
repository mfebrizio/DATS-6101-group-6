...
ci99_in_mh_rate <- paste0("[", paste0(round(ttest99_mh_rate$conf.int, 4), collapse = ", "), "]")
...
for (r in region_list) {
  ...
  ttest99_days <- t.test(ranked_region$mental_health_days, conf.level=0.99)
  ttest99_rate <- t.test(ranked_region$mental_distress_rate, conf.level=0.99)
  
  
  print(paste0(r,"'s income inequality: [", paste0(round(ttest99_in$conf.int, 4), collapse = ", "), "]"))
  print(paste0(r,"'s poor mental health days: [", paste0(round(ttest99_days$conf.int, 4), collapse = ", "), "]"))
  print(paste0(r,"'s frequent mental distress rate: [", paste0(round(ttest99_rate$conf.int, 4), collapse = ", "), "]"))
