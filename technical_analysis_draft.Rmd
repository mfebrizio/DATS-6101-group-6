...
```{r scatter, results='markup'}

# data: use ranked
colnames(ranked)

# mental health vars vs. inequality
...
# median income vs inequality
ggplot(ranked, aes(y=median_inc/1000, x=inequality)) + 
  geom_point() +
  geom_smooth(formula = y ~ x, method=lm, se=FALSE) +  ## Add linear regression line
  labs(title = "Scatterplot")

#---
# median income vs inequality
ggplot(ranked, aes(y=unempl, x=inequality)) + 
  geom_point() +
  geom_smooth(formula = y ~ x, method=lm, se=FALSE) +  ## Add linear regression line
  labs(title = "Scatterplot")

# y vs inequality
ggplot(ranked, aes(y=child_poverty, x=inequality)) + 
  geom_point() +
  geom_smooth(formula = y ~ x, method=lm, se=FALSE) +  ## Add linear regression line
  labs(title = "Scatterplot")
...
```{r scatter_colors, results='markup'}
...
ggplot(ranked) + 
  geom_point(aes(y=mental_health_days, x=inequality, color = factor(state))) + 
  geom_smooth(aes(y=mental_health_days, x=inequality), 
              formula = y ~ x, method=lm, se=FALSE) +  ## Add linear regression line
