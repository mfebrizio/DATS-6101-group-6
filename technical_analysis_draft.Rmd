...
rankedreg <- merge(ranked, census_regions, by="state", all = TRUE)

rankedreg$region <- factor(rankedreg$region)
rankedreg$division <- factor(rankedreg$division)
