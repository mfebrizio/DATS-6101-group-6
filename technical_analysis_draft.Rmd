...
```{r boxplots_mh_rate, results='markup'}
##Assigned to: Xuan
...
h19<-ggplot(dframe2016, aes(x=region, y=inequality)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
...
h20<-ggplot(dframe2017, aes(x=region, y=inequality)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
...
h21<-ggplot(dframe2018, aes(x=region, y=inequality)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
...
h22<-ggplot(dframe2019, aes(x=region, y=inequality)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
...
h23<-ggplot(dframe2020, aes(x=region, y=inequality)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
...
h24<-ggplot(dframe2021, aes(x=region, y=inequality)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
  labs(title="2021")


histplot4 <- grid.arrange(h19,h20,h21,h22,h21,h24, nrow=2, ncol=3)
annotate_figure(histplot3, top = text_grob("The Characterization of Income Inequality by Region per Year", color = "black", face = "bold", size = 14))
...
var(dframe0NA$median_inc)
var(dframe0NA$inequality)
var(dframe0NA$mental_health_days)
var(dframe0NA$mental_distress_rate)

sd(dframe0NA$median_inc)
sd(dframe0NA$inequality)
sd(dframe0NA$mental_health_days)
sd(dframe0NA$mental_distress_rate)

# Variance, standard of selected independent variables and dependent variables in 2016
var(dframe2016$median_inc)
var(dframe2016$inequality)
var(dframe2016$mental_health_days)
var(dframe2016$mental_distress_rate)
sd(dframe2016$median_inc)
sd(dframe2016$inequality)
sd(dframe2016$mental_health_days)
sd(dframe2016$mental_distress_rate)

# Variance, standard of selected independent variables and dependent variables in 2017
var(dframe2017$median_inc)
var(dframe2017$inequality)
var(dframe2017$mental_health_days)
var(dframe2017$mental_distress_rate)
sd(dframe2017$median_inc)
sd(dframe2017$inequality)
sd(dframe2017$mental_health_days)
sd(dframe2017$mental_distress_rate)

# Variance, standard of selected independent variables and dependent variables in 2018
var(dframe2018$median_inc)
var(dframe2018$inequality)
var(dframe2018$mental_health_days)
var(dframe2018$mental_distress_rate)
sd(dframe2018$median_inc)
sd(dframe2018$inequality)
sd(dframe2018$mental_health_days)
sd(dframe2018$mental_distress_rate)

# Variance, standard of selected independent variables and dependent variables in 2019
var(dframe2019$median_inc)
var(dframe2019$inequality)
var(dframe2019$mental_health_days)
var(dframe2019$mental_distress_rate)
sd(dframe2019$median_inc)
sd(dframe2019$inequality)
sd(dframe2019$mental_health_days)
sd(dframe2019$mental_distress_rate)

# Variance, standard of selected independent variables and dependent variables in 2020
var(dframe2020$median_inc)
var(dframe2020$inequality)
var(dframe2020$mental_health_days)
var(dframe2020$mental_distress_rate)
sd(dframe2020$median_inc)
sd(dframe2020$inequality)
sd(dframe2020$mental_health_days)
sd(dframe2020$mental_distress_rate)

# Variance, standard of selected independent variables and dependent variables in 2021
var(dframe2021$median_inc)
var(dframe2021$inequality)
var(dframe2021$mental_health_days)
var(dframe2021$mental_distress_rate)
sd(dframe2021$median_inc)
sd(dframe2021$inequality)
sd(dframe2021$mental_health_days)
sd(dframe2021$mental_distress_rate)
