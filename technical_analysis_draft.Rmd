...
Next, we conducted a $\chi^2$ test of independence to see whether our dependent and independent var are independent


```{r chi_test, results='markup'}

# create contingency table
contable = table(ranked$inequality, ranked$mental_health_days)
xkabledply(contable, title="Contingency table for Inequality vs. Poor Mental Health Days")
