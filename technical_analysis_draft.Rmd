...
ggplot(dframe2016, aes(x=region, y=mental_distress_rate)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
  labs(title="The Characterization of Frequent mental distress rate/month of four regions in 2016")

# Characterization of the Frequent mental distress rate of four regions in the United States in 2017.
ggplot(dframe2017, aes(x=region, y=mental_distress_rate)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
  labs(title="The Characterization of Frequent mental distress rate/month of four regions in 2017")

# Characterization of the Frequent mental distress rate of four regions in the United States in 2018.
ggplot(dframe2018, aes(x=region, y=mental_distress_rate)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
  labs(title="The Characterization of Frequent mental distress rate/month of four regions in 2018")

# Characterization of the Frequent mental distress rate of four regions in the United States in 2019.
ggplot(dframe2019, aes(x=region, y=mental_distress_rate)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
  labs(title="The Characterization of Frequent mental distress rate/month of four regions in 2019")

# Characterization of the Frequent mental distress rate of four regions in the United States in 2020.
ggplot(dframe2020, aes(x=region, y=mental_distress_rate)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
  labs(title="The Characterization of Frequent mental distress rate/month of four regions in 2020")

# Characterization of the Frequent mental distress rate of four regions in the United States in 2021.
ggplot(dframe2021, aes(x=region, y=mental_distress_rate)) + 
  geom_boxplot() + 
  geom_boxplot(colour="orange",fill="#7777cc",outlier.colour="red",outlier.shape=8, outlier.size=4) +
  labs(title="The Characterization of Frequent mental distress rate/month of four regions in 2021")

histplot <- grid.arrange(c1,c2, nrow=1, ncol=2)
