...
Given the findings from previous studies above, more research is needed to determine if there is a relationship between mental health in economic inequality. In particular, the literature review suggested to us that the relationship might also differ based on the geographic area being considered. Thus, we developed the following SMART questions:
...
The null hypothesis is that there is no relationship between mental and economic inequality. The alternative hypothesis is that there is a relationship between mental health and economic inequality. Further, we also propose that this relationship differs geographically.
...
In the first group we first analyzed the median household income of these four regions from 2016 to 2021. Evidently, the median household income in the Northeast region is the highest, followed by the West region. This is actually not difficult to imagine, because the Northeast and West regions have big cities like New York and Los Angeles. The median household incomes in the South and Midwest are relatively low.
...
In the second group, we analyzed the annual trend in median household income for each region. We can see that the trend of median household income in all 4 regions gradually upward from 2016 to 2021. In the South, the median household income in 2016 was about $40,000, and by 2021, it was close to $50,000. The data suggest that `median_inc` rose across the U.S. in the six years between 2016 and 2021.
...
In the fourth group, we separately analyzed the income inequality for these four regions over the 6 years. No matter which region it is, `inequality` has remained around 4.4%.
...
The fifth group of boxplots focuses on poor mental health days by region from 2016 to 2021. From the graph, we can easily conclude that the South has the biggest poor mental health days. This is consistent with our previous findings indicating that the South has the lowest median household income of the 4 regions. Because the South has the lowest median household income of the four regions, people in the South could be more prone to mental problems.
