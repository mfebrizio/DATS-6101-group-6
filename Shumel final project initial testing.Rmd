...
#The model with 25 variables has the highest RSquare. Variables marked with TRUE are the ones chosen.
...
#The model with 23 variables has the highest adjusted \( R^2 \). Variables marked with TRUE are the ones chosen.
...
```
#The model with 23 variables has the lowest CP.
...
#The model with 22 variables has the lowest CP.
...
#The model with  variables has the lowest CP.
