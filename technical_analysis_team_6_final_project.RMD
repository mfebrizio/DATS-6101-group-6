...
After including the set of control variables, the coefficients for `inequality` and the interaction terms are so small that the differences by region are barely noticeable. 
