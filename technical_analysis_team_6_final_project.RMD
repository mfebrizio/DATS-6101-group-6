...
The equations for the fuller models with interaction terms are below, where V~c~ is a vector of additional control variables:
* `regionMidwest`: `mental_distress_rate` = 0.04 + 0.01 * `inequality` + V~c~
* `regionNortheast`: `mental_distress_rate` = 0.04 + 0.02 + (0.01 - 0.00348) * `inequality` + V~c~
* `regionSouth`: `mental_distress_rate` = 0.04 + 0.02 + (0.01 - 0.00350) * `inequality` + V~c~
* `regionWest`: `mental_distress_rate` = 0.04 + 0.01 + (0.01 - 0.00300) * `inequality` + V~c~
