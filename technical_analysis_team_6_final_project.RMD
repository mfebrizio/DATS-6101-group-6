...
#The following codes are for Regression Trees and Random Forests
...
fancyRpartPlot(model_ment_dis_rate_tree, main = "Model 1 - Target y: mental_health_days (all vars.)")
...
#Plotting Complexity Parameters
plotcp(model_ment_dis_rate_tree, minline = TRUE, lty = 3, col = 1)
...
#Plot Complexity Penalty of Prune Tree 
plotcp(prune_model_ment_dis_rate_tree,minline = TRUE, lty = 3, col = 1)

rsq.rpart(prune_model_ment_dis_rate_tree)

#Plot Pruned Tree
fancyRpartPlot(prune_model_ment_dis_rate_tree)
...
#Plot Variable Importance 
varImpPlot(bag_ment_dis_rate, main = "Variable Importance Plots for Random Forest")
