...
```{r}
library(leaps)
reg.best10 <- regsubsets(mental_health_days~. , data = rankedfs, nvmax = NULL, nbest = 1, method = "exhaustive")
...
lm2 <- lm(rankedfs,formula=mental_health_days ~ mental_distress_rate + median_inc + college + pct_below18 + pct_black + unempl + single_parent + pct_rural + pct_hispanic + pct_native_am)
summary(lm2)
...
library(carData)
res.legend <-
    subsets(regsubsets(mental_health_days~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="adjr2", legend = FALSE, min.size = 5, main = "Adjusted R^2")
## Mallow Cp
res.legend <-
    subsets(regsubsets(mental_health_days~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="cp", legend = FALSE, min.size = 5, main = "Mallow Cp")
abline(a = 1, b = 1, lty = 2)
#BIC
res.legend <-
    subsets(regsubsets(mental_health_days~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="bic", legend = FALSE, min.size = 5, main = "BIC")
abline(a = 1, b = 1, lty = 2)
#r2
res.legend <-
    subsets(regsubsets(mental_health_days~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="rsq", legend = FALSE, min.size = 5, main = "R square")
abline(a = 1, b = 1, lty = 2)
...
#The model with 22 variables has the highest RSquare. Variables marked with TRUE are the ones chosen.

```{r}
plot(summary.out$adjr2,xlab="number of variables", ylab="R Square", type="l")
points(22, summary.out$rsq[22], col='red', cex=2, pch=20)
```
...
#The model with 21 variables has the highest adjusted \( R^2 \). Variables marked with TRUE are the ones chosen.

```{r}
plot(summary.out$adjr2,xlab="number of variables", ylab="adjr2", type="l")
points(21, summary.out$adjr2[21], col='red', cex=2, pch=20)
```
...
```
#The model with 20 variables has the lowest CP.

```{r}
plot(summary.out$cp,xlab="number of variables", ylab="cp", type="l")
points(20, summary.out$cp[20], col='red', cex=2, pch=20)
```
...
#The model with 19 variables has the lowest CP.

```{r}
plot(summary.out$bic,xlab="number of variables", ylab="BIC", type="l")
points(19, summary.out$bic[19], col='red', cex=2, pch=20)
...
test = (!train)
regfit.best=regsubsets(mental_health_days~.,data=rankedfs[train,],nvmax = 22)
test.mat = model.matrix(mental_health_days~., data = rankedfs[test,])
...
lm3 <- lm(rankedfs,formula=mental_distress_rate ~. )
summary(lm1)
...
```{r}
library(leaps)
reg2.best10 <- regsubsets(mental_distress_rate~. , data = rankedfs, nvmax = NULL, nbest = 1, method = "exhaustive")
...
lm4 <- lm(rankedfs,formula=mental_distress_rate ~ mental_health_days + food_index + pop + child_poverty + pct_black + unempl + single_parent + pct_rural + pct_hispanic + pct_native_am)
summary(lm2)
...
library(carData)
res.legend <-
    subsets(regsubsets(mental_distress_rate~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="adjr2", legend = FALSE, min.size = 5, main = "Adjusted R^2")
## Mallow Cp
res.legend <-
    subsets(regsubsets(mental_distress_rate~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="cp", legend = FALSE, min.size = 5, main = "Mallow Cp")
abline(a = 1, b = 1, lty = 2)
#BIC
res.legend <-
    subsets(regsubsets(mental_distress_rate~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="bic", legend = FALSE, min.size = 5, main = "BIC")
abline(a = 1, b = 1, lty = 2)
#r2
res.legend <-
    subsets(regsubsets(mental_distress_rate~. , data = rankedfs, nvmax = 10, nbest = 1, method = "exhaustive"), statistic="rsq", legend = FALSE, min.size = 5, main = "R square")
abline(a = 1, b = 1, lty = 2)
...
points(22, summary2.out$rsq[22], col='red', cex=2, pch=20)
```
...
points(21, summary2.out$adjr2[21], col='red', cex=2, pch=20)
```
...
points(21, summary2.out$cp[21], col='red', cex=2, pch=20)
```
...
points(19, summary2.out$bic[19], col='red', cex=2, pch=20)
#forward and backward selection is same as exhaustive just slight different in forward it start will no variable and iterate till the max variable and backward selection is otherway around.
```
