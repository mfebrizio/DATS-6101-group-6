...
The summary table of the regression tree indicate the order of varibale importance for each variable within the regression. In order of importance the variables are ranked:
...
table1_FI_tree<-summ_table1$variable.importance

data.frame(table1_FI_tree)
#table1_FI_tree
...
The next section is focuses on how good the regressions trees are at predicting the target variable. The models will be evaluated using RMSE. The lower the RMSE value the more accurate the model. The RMSE value of original regression tree is 0.427. The RMSE value of the pruned regression tree is 0.435. These RMSE values suggest that the original regression is a slight better predicting model.
